...
OUT = ROOT / "docs" / "Development_of_Flutter_Apps_for_Fourier_Transform_Dissertation_v4.docx"
IMG_DIR = ROOT / "docs" / "extracted_report_images"
...
def add_figure(doc: Document, image_name: str, caption: str, width: float = 5.8) -> None:
...
def build() -> None:
    ...
    add_figure(
        doc,
        "redrawn/hybrid_architecture_v2.png",
        "Figure 3.1 Hybrid architecture of the Flutter Fourier transform learning application.",
        width=6.1,
    )
    add_code(
        doc,
...
""",
    ...
    add_figure(
        doc,
        "redrawn/dual_computation_paths_v2.png",
        "Figure 3.2 Dual computation paths: backend symbolic derivation and local numerical visualisation.",
        width=6.1,
    )
    add_table(
        doc,
...
""",
    ...
    add_figure(
        doc,
        "redrawn/teaching_chart_layout_v2.png",
        "Figure 4.1 4+1 teaching chart layout for numerical Fourier transform understanding.",
        width=6.1,
    )
    para(
        doc,
    ...
    add_figure(
        doc,
        "redrawn/symbolic_data_flow_v2.png",
        "Figure 5.1 Symbolic derivation data flow from user input to Flutter rendering.",
        width=5.9,
    )
    add_code(
        doc,
...
""",
    ...
    add_figure(
        doc,
        "rule_priority_pipeline_v2.png",
        "Figure 5.2 Rule-first priority pipeline used before controlled fallback.",
        width=6.1,
    )
    para(
        doc,
